            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
                    ...
                    <ul class="kt-menu__nav ">
                        ...
                        <li class="kt-menu__item {{ (Request::is('admin/users') ? 'kt-menu__item--active' : '') || (Request::is('admin/user/*') ? 'kt-menu__item--active' : '') }}"
                            aria-haspopup="true">
                        ...
                        @endif
                        @if($u->superadmin)
                            <li class="kt-menu__item {{ (Request::is('admin/giveaway') ? 'kt-menu__item--active' : '') }}"
                                aria-haspopup="true">
                        ...
                        @endif
                        <li class="kt-menu__item {{ (Request::is('admin/promo') ? 'kt-menu__item--active' : '') }}"
                            aria-haspopup="true">
                        ...
                        <!--
								<li class="kt-menu__item {{ (Request::is('admin/tasks') ? 'kt-menu__item--active' : '') }}" aria-haspopup="true">
								...
								<li class="kt-menu__item {{ (Request::is('admin/sysmessages') ? 'kt-menu__item--active' : '') }}" aria-haspopup="true">
								...
								<li class="kt-menu__item {{ (Request::is('admin/adverts') ? 'kt-menu__item--active' : '') }}" aria-haspopup="true">
...
-->
                        ...
                        @if($u->superadmin)
                            ...
                            @if($u->isDeveloper)
                            <li class="kt-menu__item {{ (Request::is('admin/payment_gateways') ? 'kt-menu__item--active' : '') }}"
                                aria-haspopup="true">
...
<g><path style="opacity:0.787" fill="#0e1216" d="M 10.5,0.5 C 11.5,0.5 12.5,0.5 13.5,0.5C 13.5,1.5 13.5,2.5 13.5,3.5C 14.8333,3.5 16.1667,3.5 17.5,3.5C 17.5,4.83333 17.5,6.16667 17.5,7.5C 16.1779,7.66997 15.0113,7.33663 14,6.5C 13.5172,7.44802 13.3505,8.44802 13.5,9.5C 17.9757,9.82222 19.4757,12.1556 18,16.5C 14.7934,17.2546 13.2934,19.2546 13.5,22.5C 12.5,22.5 11.5,22.5 10.5,22.5C 10.5,21.1667 10.5,19.8333 10.5,18.5C 8.83333,18.5 7.16667,18.5 5.5,18.5C 5.5,17.1667 5.5,15.8333 5.5,14.5C 7.14387,14.2865 8.64387,14.6198 10,15.5C 10.4828,14.552 10.6495,13.552 10.5,12.5C 7.41514,12.582 5.74847,11.082 5.5,8C 5.74847,4.91798 7.41514,3.41798 10.5,3.5C 10.5,2.5 10.5,1.5 10.5,0.5 Z"/></g>
                        ...
                        <li class="kt-menu__item {{ (Request::is('admin/filter') ? 'kt-menu__item--active' : '') }}"
                            aria-haspopup="true">
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        ...
                        <div
                            ...
                            <div class="kt-notification">
                                <a href="/admin/user/{{$u->id}}" class="kt-notification__item">
