				...
				<div class="tab-content">
							...
							<div class="form-group row">
								...
								<div class="col-lg-4">
									...
									<select class="form-control" name="site_disable">
										<option value="0" {{ ($settings->site_disable == 0) ? 'selected' : '' }}>Desligado</option>
										<option value="1" {{ ($settings->site_disable == 1) ? 'selected' : '' }}>Ligado</option>
									</select>
								</div>
								<div class="col-lg-4">
						...
						<!--<div class="kt-section">
							...
							<div class="form-group row">
								...
								<div class="col-sm-1-5">
									...
									<input type="text" class="form-control" name="webmoney_com_rub" value="{{$settings->webmoney_com_rub}}" placeholder="руб">
									<label>FkWallet Мин. сумма</label>
									<input type="text" class="form-control" name="webmoney_min" value="{{$settings->webmoney_min}}" placeholder="Мин. сумма">
								</div>
								<div class="col-sm-1-5">
									<label>Payeer (+%)</label>
									<input type="text" class="form-control" name="payeer_com_percent" value="{{$settings->payeer_com_percent}}" placeholder="%">
									<label>Payeer (+руб)</label>
									<input type="text" class="form-control" name="payeer_com_rub" value="{{$settings->payeer_com_rub}}" placeholder="руб">
									<label>Payeer Мин. сумма</label>
									<input type="text" class="form-control" name="payeer_min" value="{{$settings->payeer_min}}" placeholder="Мин. сумма">
							 	</div>
								<div class="col-sm-1-5">
									<label>VISA (+%)</label>
					...
					<div class="tab-pane" id="jackpot" role="tabpanel">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="digite uma porcentagem" value="{{$settings->jackpot_commission}}" name="jackpot_commission">
						</div>
						@foreach($rooms as $r)
						<div class="kt-section">
							<h3 class="kt-section__title">
							...
							<div class="form-group row">
								<div class="col-lg-3">
									...
									<input type="text" class="form-control" name="time_{{$r->name}}" value="{{$r->time}}" placeholder="Tempo">
								</div>
								<div class="col-lg-3">
									<label>Valor minimo de aposta:</label>
									<input type="text" class="form-control" name="min_{{$r->name}}" value="{{$r->min}}" placeholder="valor minimo de aposta">
								</div>
								<div class="col-lg-3">
									<label>Valor máximo da aposta:</label>
									<input type="text" class="form-control" name="max_{{$r->name}}" value="{{$r->max}}" placeholder="Valor máximo da Aposta">
								</div>
								<div class="col-lg-3">
									<label>Quantidade de apostas máximas por jogador:</label>
									<input type="text" class="form-control" name="bets_{{$r->name}}" value="{{$r->bets}}" placeholder="Quantidade de apostas máximas por jogador">
								</div>
							</div>
						</div>
						@endforeach
					...
					<div class="tab-pane" id="pvp" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-4">
								...
								<input type="text" class="form-control" placeholder="valor da comissão em %" value="{{$settings->flip_commission}}" name="flip_commission">
							</div>
							<div class="col-lg-4">
								<label>Valor mínimo da aposta:</label>
								<input type="text" class="form-control" placeholder="valor da aposta" value="{{$settings->flip_min_bet}}" name="flip_min_bet">
							</div>
							<div class="col-lg-4">
								<label>Valor máximo da aposta:</label>
								<input type="text" class="form-control" placeholder="valor da aposta" value="{{$settings->flip_max_bet}}" name="flip_max_bet">
							</div>
						</div>
					</div>
