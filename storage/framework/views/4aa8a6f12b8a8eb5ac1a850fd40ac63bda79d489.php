...
<head>
    <meta charset="utf-8"/>
    <title><?php echo e($settings->sitename); ?> | Painel de controle</title>
...
<body
    class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading" style="background-color: #1e1e2d">
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    ...
    <div class="kt-header-mobile__toolbar" style="background-color: #1e1e2d">
...
<div class="kt-grid kt-grid--hor kt-grid--root" style="background-color: #1e1e2d">
                    ...
                    <ul class="kt-menu__nav ">
                        <li class="kt-menu__item <?php echo e((Request::is('admin') ? 'kt-menu__item--active' : '')); ?>"
                            ...
                            <a href="/admin" class="kt-menu__link">
                                ...
                                <span class="kt-menu__link-text">Estatistíca</span>
                            </a>
                        </li>
                        ...
                        <li class="kt-menu__item <?php echo e((Request::is('admin/users') ? 'kt-menu__item--active' : '') || (Request::is('admin/user/*') ? 'kt-menu__item--active' : '')); ?>"
                            aria-haspopup="true">
                        ...
                        <?php if($u->superadmin): ?>
                            <li class="kt-menu__item <?php echo e((Request::is('admin/bots') ? 'kt-menu__item--active' : '')); ?>"
                                aria-haspopup="true">
                                <a href="/admin/bots" class="kt-menu__link">
										<span class="kt-menu__link-icon">
											<svg xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                 viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                    ...
                                    <span class="kt-menu__link-text">Bots</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if($u->superadmin): ?>
                            <li class="kt-menu__item <?php echo e((Request::is('admin/giveaway') ? 'kt-menu__item--active' : '')); ?>"
                                aria-haspopup="true">
                                <a href="/admin/giveaway" class="kt-menu__link">
										<span class="kt-menu__link-icon">
											<svg xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                 viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect id="bound" x="0" y="0" width="24" height="24"/>
													<polygon id="Path-48" fill="#000000" opacity="0.3"
                                                             points="5 3 19 3 23 8 1 8"/>
													<polygon id="Path-48-Copy" fill="#000000" points="23 8 12 20 1 8"/>
												</g>
											</svg>
										</span>
                                    <span class="kt-menu__link-text">Prêmios</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <li class="kt-menu__item <?php echo e((Request::is('admin/promo') ? 'kt-menu__item--active' : '')); ?>"
                            aria-haspopup="true">
                        ...
                        <!--
								<li class="kt-menu__item <?php echo e((Request::is('admin/tasks') ? 'kt-menu__item--active' : '')); ?>" aria-haspopup="true">
									<a href="/admin/tasks" class="kt-menu__link">
										<span class="kt-menu__link-icon">
										...
										<span class="kt-menu__link-text">Задания</span>
									</a>
								</li>
								<li class="kt-menu__item <?php echo e((Request::is('admin/sysmessages') ? 'kt-menu__item--active' : '')); ?>" aria-haspopup="true">
									<a href="/admin/sysmessages" class="kt-menu__link">
										<span class="kt-menu__link-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect id="bound" x="0" y="0" width="24" height="24"/>
										...
										<span class="kt-menu__link-text">Системные сообщения</span>
									</a>
								</li>
								<li class="kt-menu__item <?php echo e((Request::is('admin/adverts') ? 'kt-menu__item--active' : '')); ?>" aria-haspopup="true">
									<a href="/admin/adverts" class="kt-menu__link">
										<span class="kt-menu__link-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect id="bound" x="0" y="0" width="24" height="24"/>
										...
										<span class="kt-menu__link-text">Группы</span>
									</a>
								</li>
-->
                        ...
                        <li class="kt-menu__item <?php echo e((Request::is('admin/withdraws') ? 'kt-menu__item--active' : '')); ?>"
                            ...
                            <a href="/admin/withdraws" class="kt-menu__link">
                                ...
                                <span class="kt-menu__link-text">Resumos de Transações</span>
                            </a>
                        </li>
                        ...
                        <?php if($u->superadmin): ?>
                            <li class="kt-menu__item <?php echo e((Request::is('admin/settings') ? 'kt-menu__item--active' : '')); ?>"
                                ...
                                <a href="/admin/settings" class="kt-menu__link">
                                    ...
                                    <span class="kt-menu__link-text">Configurações</span>
                                </a>
                            </li>
                            <?php if($u->isDeveloper): ?>
                            <li class="kt-menu__item <?php echo e((Request::is('admin/payment_gateways') ? 'kt-menu__item--active' : '')); ?>"
                                aria-haspopup="true">
                                <a href="/admin/payment_gateways" class="kt-menu__link">
										<span class="kt-menu__link-icon">
											<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="24px" height="24px" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" xmlns:xlink="http://www.w3.org/1999/xlink">
<g><path style="opacity:0.787" fill="#0e1216" d="M 10.5,0.5 C 11.5,0.5 12.5,0.5 13.5,0.5C 13.5,1.5 13.5,2.5 13.5,3.5C 14.8333,3.5 16.1667,3.5 17.5,3.5C 17.5,4.83333 17.5,6.16667 17.5,7.5C 16.1779,7.66997 15.0113,7.33663 14,6.5C 13.5172,7.44802 13.3505,8.44802 13.5,9.5C 17.9757,9.82222 19.4757,12.1556 18,16.5C 14.7934,17.2546 13.2934,19.2546 13.5,22.5C 12.5,22.5 11.5,22.5 10.5,22.5C 10.5,21.1667 10.5,19.8333 10.5,18.5C 8.83333,18.5 7.16667,18.5 5.5,18.5C 5.5,17.1667 5.5,15.8333 5.5,14.5C 7.14387,14.2865 8.64387,14.6198 10,15.5C 10.4828,14.552 10.6495,13.552 10.5,12.5C 7.41514,12.582 5.74847,11.082 5.5,8C 5.74847,4.91798 7.41514,3.41798 10.5,3.5C 10.5,2.5 10.5,1.5 10.5,0.5 Z"/></g>
</svg>

										</span>
                                    <span class="kt-menu__link-text">Prov. de Pagamentos</span>
                                </a>
                            </li>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <li class="kt-menu__section ">
                            <h4 class="kt-menu__section-text">Chat</h4>
                            <i class="kt-menu__section-icon flaticon-more-v2"></i>
                        </li>
                        <li class="kt-menu__item <?php echo e((Request::is('admin/filter') ? 'kt-menu__item--active' : '')); ?>"
                            aria-haspopup="true">
                            <a href="/admin/filter" class="kt-menu__link">
                                ...
                                <span class="kt-menu__link-text">Filtro de Palavras</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                        ...
                        <?php if($u->superadmin): ?>
                            <ul class="kt-menu__nav ">
                                <li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here">
                                    <button type="button" class="btn btn-success socketStart">Ligar Socket</button>
                                </li>
                                <li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here">
                                    <button type="button" class="btn btn-danger socketStop">Desligar Socket</button>
                                </li>
                            </ul>
                        <?php endif; ?>
                    </div>
            ...
            <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                <div class="kt-footer__copyright">
                    <?= date("Y") ?> - <?php echo e($settings->domain); ?>
                </div>
            </div>
