				...
				<div class="table-wrap" style="transform: translateY(0px);">
					<table class="table">
						<tbody>
							...
							<tr>
								<td class="username">
									<button type="button" class="btn btn-link" data-id="<?php echo e(\App\Model\User::getUser($end->heads)->unique_id); ?>">
										<span class="sanitize-user">
											<div class="sanitize-avatar"><img src="<?php echo e(\App\Model\User::getUser($end->heads)->avatar); ?>" alt=""></div>
											<span class="sanitize-name"><?php echo e(\App\Model\User::getUser($end->heads)->username); ?></span>
										</span>
									</button>
								</td>
								<td class="username">
									<button type="button" class="btn btn-link" data-id="<?php echo e(\App\Model\User::getUser($end->tails)->unique_id); ?>">
										<span class="sanitize-user">
											<div class="sanitize-avatar"><img src="<?php echo e(\App\Model\User::getUser($end->tails)->avatar); ?>" alt=""></div>
											<span class="sanitize-name"><?php echo e(\App\Model\User::getUser($end->tails)->username); ?></span>
										</span>
									</button>
								</td>
								<td class="username">
									<button type="button" class="btn btn-link" data-id="<?php echo e(\App\Model\User::getUser($end->winner_id)->unique_id); ?>">
										<span class="sanitize-user">
											<div class="sanitize-avatar"><img src="<?php echo e(\App\Model\User::getUser($end->winner_id)->avatar); ?>" alt="" style="border: solid 1px #4986f5;"></div>
											<span class="sanitize-name"><?php echo e(\App\Model\User::getUser($end->winner_id)->username); ?></span>
										</span>
									</button>
								</td>
								<td>
									<div class="bet-number">
										<span class="bet-wrap">
											...
											<svg class="icon icon-coin balance <?php echo e($end->balType); ?>">
								...
								<td>
									<button class="btn btn-primary checkGame" data-hash="<?php echo e($end->hash); ?>">Verificar</button>
								</td>
							</tr>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</tbody>
