...
<?php else: ?>
    ...
    <?php if(Auth::user() && $u->ban): ?>
        ...
        <div class="logo">
            ...
            <?php endif; ?>
            <a href="<?php echo e($settings->vk_url); ?>" class="vk" target="_blank"><span>Ir para o grupo </span><i
                    class="fab fa-vk"></i></a>
        ...
        <?php else: ?>
            ...
            <head>
                ...
                <script src="templates/rushb3t/js/vendor.min.js" type="text/javascript"></script>
                <script src="templates/rushb3t/js/scriptsfaed.js?v=675056" type="text/javascript"></script>
                <script src="templates/rushb3t/js/datepicker.js" type="text/javascript"></script>
                <script src="templates/rushb3t/js/betnew/mainfaed.js?v=675056"></script>
                <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css" integrity="sha512-+4zCK9k+qNFUR5X+cKL9EIR+ZOhtIloNl9GIKS57V1MyNsYpYcUrUeQc9vNfzsWfV28IaLL3i96P9sdNyeRssA==" crossorigin="anonymous" />
            ...
            <div class="wrapper">
                <div class="header">
                    <div class="logoheader">
                        <a href="/"> <img src="/img/logonew.png" width="150px"> </a>
                    </div>
                                    ...
                                    <div class="btn-swap">
                                        <a href="/" class="one-btn-swap active">
                                            <svg data-v-3749ce64="" width="24" height="24" focusable="false"
                                                ...
                                                <use data-v-3749ce64=""
                                                     xlink:href="/templates/rushb3t/img/betnew/svg-sprite.e1149d9.svg#icon-casino"
                                                     class="svg-use"></use>
                                            </svg>
                                            Cassino
                                        </a>
                                ...
                                <div class="bottom-start rounded dropdown">
                                    <button type="button" aria-haspopup="true" aria-expanded="false"
                                        ...
                                        <div class="selected balance">
                                            <img src="/img/MOEDA_BETFYRE_01_0001.png" height="30px"/>
                                        </div>
                                    </button>
                                    <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu"
                                        ...
                                        <button type="button" data-id="balance" tabindex="0" role="menuitem"
                                            ...
                                            <div class="balance-item balance">
                                                ...
                                                <div class="value" id="balance_bal"><strong><?php echo e($u->balance); ?></strong>
                                                </div>
                                            </div>
                                        </button>
                                    </div>
                    ...
                    <div class="left-sidebar">
                        <ul class="side-nav">
                                ...
                                <div class="one-menu">
                                    <a href="/affiliate">
                                        <div class="img-one-menu">
                                            <svg width="24" height="24" focusable="false" aria-hidden="true" class="">
                                                <use
                                                    xlink:href="/templates/rushb3t/img/betnew/svg-sprite.e1149d9.svg#icon-earn"
                                                    class="svg-use"></use>
                                            </svg>
                                        </div>
                                        Afiliados</a>
                                ...
                                <div class="one-menu">
                                    <a data-toggle="modal" data-target="#promoModal">
                                        <div class="img-one-menu">
                                            <svg width="24" height="24" focusable="false" aria-hidden="true" class="">
                                                <use
                                                    xlink:href="/templates/rushb3t/img/betnew/svg-sprite.e1149d9.svg#icon-funfury-competition"
                                                    class="svg-use"></use>
                                            </svg>
                                        </div>
                                    ...
                                    <div class="h-one-open-menu">
                                        <a href="javascript:;" class="a-to-open-d">
                                            ...
                                            <svg data-v-10d563d5="" width="24" height="24" focusable="false"
                                                ...
                                                <use data-v-10d563d5=""
                                                     xlink:href="/templates/rushb3t/img/betnew/svg-sprite.e1149d9.svg#icon-arrow-right-small"
                                                     class=""></use>
                                            </svg>
                                        </a>
                                    </div>
                                        ...
                                        <a href="/profile">
                                            <div class="img-one-menu">
                                                <svg width="16" height="16" focusable="false" aria-hidden="true"
                                                     class="">
                                                    <use
                                                        xlink:href="/templates/rushb3t/img/betnew/svg-sprite.e1149d9.svg#icon-staking"
                                                        class="svg-use"></use>
                                                </svg>
                                            </div>
                                            Minha Conta</a>
                            ...
                            <div class="support-menu">
                                <a href="https://jivo.chat/5tIx2ulveu" target="_blank">
                                    <svg data-v-7e25d36a="" focusable="false" aria-hidden="true" class="">
                                        <use data-v-7e25d36a=""
                                             xlink:href="/templates/rushb3t/img/betnew/svg-sprite.e1149d9.svg#icon-live-support"
                                             class="svg-use"></use>
                                    </svg>
                                    Suporte</a>
                            </div>
                            ...
                            <div class="social-menu">
                                <a href="https://t.me/+28KOrKR_t2IzMmUx" target="_blank">
                                    <svg data-v-7627c91c="" width="20" height="20" focusable="false" aria-hidden="true"
                                         class="chats-channels__icon">
                                        <use data-v-7627c91c=""
                                             xlink:href="/templates/rushb3t/img/betnew/svg-sprite.e1149d9.svg#icon-telegram"
                                             class="svg-use"></use>
                                    </svg>
                                </a>
                                <a href="https://instagram.com/betfyre?igshid=MDM4ZDc5MmU=" target="_blank">
                                    <svg data-v-a9c109c4="" width="24" height="24" focusable="false" aria-hidden="true"
                                         class="">
                                        <use data-v-a9c109c4=""
                                             xlink:href="/templates/rushb3t/img/betnew/svg-sprite.e1149d9.svg#icon-instagram"
                                             class="svg-use"></use>
                                    </svg>
                                </a>
                            </div>
            ...
            <div class="footer">
                ...
                <div class="footer">
                    ...
                    <div class="container-mobile" style="display: none;">
                        <div class="license">
                            <img style="margin-bottom: 8px;" src="/img/logonew.png" alt="">
                        ...
                        <div class="games">
                            ...
                            <div class="game-list">
                                ...
                                <a href="/dice">
                                 ...
                                 <a href="/coinflip">
                                    <div class="double txt-label">Batalha</div>
                                </a>
                                 <a href="/tower">
                                                    ...
                                                    <div class="form-field">
                                                        <div class="input-valid">
                                                            <input class="input-field input-with-icon" name="amount"
                                                                   value="<?php echo e($settings->min_dep); ?>"
                                                                   placeholder="">
                                                ...
                                                <div class="select-payment">
                                                    ...
                                                    <div class="bottom-start dropdown">
                                                        ...
                                                        <button type="button" aria-haspopup="true"
                                                            ...
                                                            <div class="opener">
                                                                <svg class="icon icon-down">
                                                                    <use
                                                                        xlink:href="<?php echo e(url('/')); ?>/img/symbols.svg#icon-down"></use>
                                                                </svg>
                                                            </div>
                                                        </button>
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                            ...
                                                            <?php $__currentLoopData = $payment_provider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <button type="button" data-id="5" tabindex="0"
                                                                        role="menuitem" class="dropdown-item"
                                                                        data-system="<?php echo e($pp->provider_name); ?>">
                                                                    <div class="image"><img
                                                                            src="<?php echo e(url('/')); ?>/img/wallets/pix.svg"
                                                                            alt="<?php echo e($pp->payment_methods); ?> do <?php echo e($pp->payment_methods); ?>">
                                                                    </div>
                                                                    <span><?php echo e($pp->payment_methods); ?></span>
                                                                </button>
                                                ...
                                                <div class="form-field">
                                                    <div class="input-valid">
                                                        <input class="input-field input-with-icon"
                                                               value="<?php echo e($u->requery); ?>" readonly>
                                                        <div class="input-icon">
                                                        </div>
                                                ...
                                                <div class="form-field">
                                                    <div class="input-valid">
                                                        <input class="input-field"
                                                               <?php echo e($u->cpf != NULL ? 'readonly' : ''); ?> name="purse"
                                                               placeholder=""
                                                               value="<?php echo e($u->cpf != NULL ? $u->cpf : ''); ?>"
                                                               id="numwallet">
                                                    </div>
                                                </div>
                                            </label>
                    ...
                    <div class="modal-dialog faucet-demo-modal modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="faucet-container">
                                ...
                                <div class="caption-line"><span class="span"><img src="/img/MOEDA_BETFYRE_01_0001.png" height="30px"/></span></div>
                                <div class="faucet-modal-form">
                                    <div class="faucet-reload"><span>Digite Um Valor</span>
                                        <span><?php echo e($settings->exchange_min); ?></span>
                                ...
                                <div class="faucet-modal-form">
                                    <div class="faucet-reload"><span>Valor</span>
                                        <span><?php echo e($settings->exchange_curs); ?></span>
                                        <img src="/img/MOEDA_BETFYRE_01_0001.png" height="30px"/>
                                        = <span>1</span>
                                        <img src="/img/MOEDA_BETFYRE_01_0001.png" height="30px"/>
                                    </div>
                            ...
                            <div class="faucet-container">
                                ...
                                <div class="gv-list">
                                    <?php $__empty_1 = true; $__currentLoopData = $gives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="faucet-modal-give <?php echo e($gv->status == 1 ? 'doneGive' : ''); ?>"
                                             id="gv_<?php echo e($gv->id); ?>">
                                            <div class="give-btn-block">
                                                <div class="faucet-reload">
                                                    <div class="faucet-cd">Sorteios #<?php echo e($gv->id); ?></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="bank-text">Valor:</div>
                                                    <div class="bank-amount"><?php echo e($gv->sum); ?>

                                                        <svg class="icon icon-coin balance <?php echo e($gv->type); ?>">
                                                            <use xlink:href="/img/symbols.svg#icon-coin"></use>
                                                        </svg>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    ...
                                                    <div
                                                        class="date-of"><?php echo e($gv->status == 0 ? $gv->time_to : 'Participantes'); ?></div>
                                                </div>
                                            </div>
                                            <?php if($gv->status == 0): ?>
                                                <?php if($gv->group_sub != 0 || $gv->min_dep != 0): ?>
                                                    <div class="give-btn-block nowGive">
                                                        <div class="faucet-reload">
                                                            ...
                                                            <div class="text-left">
                                                                <?php if($gv->group_sub != 0 && $settings->vk_url): ?>
                                                                    <div class="faucet-sm-text">• Participe em nosso
                                                                        canal <a href="<?php echo e($settings->vk_url); ?>"
                                                                ...
                                                                <?php if($gv->min_dep != 0): ?>
                                                                    <div class="faucet-sm-text">• Recarregue sua
                                                                        conta
                                                                        com
                                                                        quantia R$ <?php echo e($gv->min_dep); ?> para o dia
                                                                        atual.
                                                                    </div>
                                                                <?php endif; ?>
                                                            </div>
                                                ...
                                                <div class="give-btn-block nowGive">
                                                    <button type="button" class="btn btn-green joinGiveaway"
                                                            data-id="<?php echo e($gv->id); ?>"><span>PARTICIPAR</span></button>
                                                    <div class="faucet-sm-text">Participantes: <span
                                                            class="total_users"><?php echo e($gv->total); ?></span></div>
                                                </div>
                                            <?php endif; ?>
                                            <div class="give-btn-block">
                                                <div class="faucet-reload">
                                                    ...
                                                    <div class="winnerGive">
                                                        <?php if($gv->status > 0 && !is_null($gv->winner_id)): ?>
                                                            <button type="button" class="btn btn-link"
                                                                    data-id="<?php echo e($gv->winner->unique_id); ?>">
                        ...
                        <div class="tos-modal-container">
                            <div class="scrollbar-container tos-modal-block ps">
                                ...
                                <p>1.1. Este contrato (doravante denominado "Contrato") rege os termos e condições,
                                    ...
                                    «<?php echo e($settings->domain); ?>», doravante referido como
                                ...
                                <p>2.3. O participante concorda que é pessoalmente responsável por todas as ações,
                                    feito com os jogos de (<?php echo e($settings->domain); ?>): comprando e vendendo,
                                ...
                                <p>3.1.1. Participe do jogo «<?php echo e($settings->domain); ?>» apenas pessoas que atingiram
                                ...
                                <p>4.1.1.2. acompanhar o inventário do jogo (<?php echo e($settings->domain); ?>) na conta do jogo
                                    participante.</p>
                                ...
                                <p>4.1.1.6. Qualquer pessoa legalmente em posse de equipamento de jogo
                                    ...
                                    (<?php echo e($settings->domain); ?>), menos o custo desta operação.</p>
                                ...
                                <p>5.10. O Organizador tem o direito de rescindir este Acordo unilateralmente
                                    ...
                                    inventário (<?php echo e($settings->domain); ?>) na conta e na conta do jogo
                ...
                <div class="modal-dialog fair-modal modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="fair-modal__container">
                            ...
                            <span><?php echo e($settings->min_dep_withdraw); ?><br><br> <?php echo e($settings->requery_bet_perc); ?><?php echo e($settings->requery_perc); ?><br><br> </span>
                        </div>
                    </div>
                </div>
            </div>
