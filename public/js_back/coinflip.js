	...
	socket.on('new.flip', function (data) {
		if(USER_ID == data.unique_id) {
			var you = '';
				...
				you += '</div>';
				you += '<div class="info">';
				you += '<div class="name">Ожидаем оппонента</div>';
				...
				you += '<div class="bank">';
				you += '<span class="type">Apostas da Partida:</span>';
				you += '<span class="val"><span>'+ data.bank +'</span> <svg class="icon icon-coin balance '+ data.balType +'"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></span>';
				you += '</div>';
				you += '<div class="ticket">';
				you += '<span class="type">Tickets:</span>';
		...
		var all = '';
			...
			all += '<div class="players block">';
			all += '<div class="user">';
			all += '<button type="button" class="btn btn-primary btn-join" data-id="'+ data.id +'"><span>Entrar</span></button>';
			all += '</div>';
			all += '</div>';
			all += '</div>';
			all += '</div>';
			...
			all += '<div class="bank">';
			all += '<span class="type">Apostas da Partida:</span>';
			all += '<span class="val"><span>'+ data.bank +'</span> <svg class="icon icon-coin balance '+ data.balType +'"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></span>';
			all += '</div>';
			all += '<div class="ticket">';
			all += '<span class="type">Tickets:</span>';
